...
class PrescriptionAdapter (private val context: Context, private val listPounch: List<Model>,
 ...
 */
        holder.itemView.setOnClickListener { clickOnListener.onClickListenerPrescription(Model()) }
